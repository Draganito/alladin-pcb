...
what the AI did. Zone fill stays in the GUI. MCP runs on its own thread.
File dialogs and Gerber export run on a worker: the GUI stays responsive
and the AI is not stalled.

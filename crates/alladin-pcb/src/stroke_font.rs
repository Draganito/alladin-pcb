...
//! Alladin previews" and "what the native Gerber export plots" the
//! *same picture*: the GUI draws these exact polylines, the DFM
//! collision in `crate::board_doc` checks these exact polylines
//! (inflated by the text's real line width), and native Gerber strokes
//! them.
//!

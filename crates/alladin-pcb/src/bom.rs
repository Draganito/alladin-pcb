...
//! this editor has no equivalent of -- see the development log's
//! "Teil 29" MVP-order decision: no schematic editor, netting happens by
//! direct pin-to-net assignment on the layout itself). Every fact a BOM
...
/// crash the whole export" precedent as `crate::kicad_export::
/// build_write_footprints`. A template with
